...
void main() {
  testWidgets('Lobby hides login controls when WS auth headers are unsupported', (tester) async {
  ...
  testWidgets('LoginScreen renders guest-only UX when WS auth headers are unsupported', (tester) async {
