...
void main() {
  testWidgets('Lobby shows spectator count in match list', (tester) async {
    ...
    expect(find.textContaining('spectators: 3'), findsOneWidget);
  ...
  testWidgets('Match screen shows spectating chips', (tester) async {
    final auth = AuthService();
    auth.continueAsGuest(displayName: 'Fran');
    ...
    expect(find.text('spectators: 4'), findsOneWidget);
  ...
  testWidgets('Table screen hides hand and shows spectating banner', (
    tester,
  ) async {
    final auth = AuthService();
    auth.continueAsGuest(displayName: 'Fran');
    ...
    expect(find.text('Spectating'), findsOneWidget);
    expect(find.text('spectators: 2'), findsOneWidget);
    expect(
      find.text('Spectating: hands and commands are hidden.'),
      findsOneWidget,
    );
